...
public class EmploymentDataRetriever {
        public ArrayList<EmploymentData> getData(Context context, String municipality) {
            ...
            try {
                ...
                JsonNode jsonInputString = objectMapper.readTree(context.getResources().openRawResource(R.raw.queryemploy));
                ...
                ArrayList<EmploymentData> employmentRateData = new ArrayList<>();
                for(int i = 0; i < years.size(); i++) {
                    employmentRateData.add(new EmploymentData(Integer.valueOf(years.get(i)), populations.get(i)));  // Using double for population
                }
